...
export default function TeacherCalendarSync() {
      ...
      <div className="bg-card border border-border rounded-lg p-6 text-center">
        ...
        {icsToken ? (
          <div className="space-y-3">
            <div className="bg-secondary rounded-md p-3 text-xs text-muted-foreground break-all font-mono">{icsUrl}</div>
            ...
            <div className="grid grid-cols-2 gap-2 mt-4">
              <a href={`https://calendar.google.com/calendar/r?cid=webcal://${icsUrl?.replace('https://', '').replace('http://', '')}`} target="_blank" rel="noopener noreferrer" className="block">
